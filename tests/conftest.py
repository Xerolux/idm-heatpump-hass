...
def _stub_idm_heatpump() -> None:
    ...
    idm_mod.FEATURE_CASCADE = "cascade"  # type: ignore[attr-defined]
    idm_mod.FEATURE_HEATING_CIRCUITS = "heating_circuits"  # type: ignore[attr-defined]
    idm_mod.FEATURE_ISC = "isc"  # type: ignore[attr-defined]
    idm_mod.FEATURE_PV = "pv"  # type: ignore[attr-defined]
    idm_mod.FEATURE_SOLAR = "solar"  # type: ignore[attr-defined]
    idm_mod.FEATURE_ZONE_MODULES = "zone_modules"  # type: ignore[attr-defined]
