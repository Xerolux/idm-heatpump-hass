...
|---------|------------------------|-----------------------------|
| Home Assistant custom integration | `0.15.0-beta.2` (previous stable: `0.14.1`) | Integration code, config flow, diagnostics, entities or bundled user documentation changes |
