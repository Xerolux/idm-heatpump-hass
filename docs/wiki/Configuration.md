...
|---------|------------------------|-----------------------------|
| Home Assistant custom integration | `0.16.0-rc.5` (previous stable: `0.15.1`) | Integration code, config flow, diagnostics, entities or bundled user documentation changes |
