...
|---------|------------------------|-----------------------------|
| Home Assistant custom integration | `0.13.0` (previous stable: `0.12.0`) | Integration code, config flow, diagnostics, entities or bundled user documentation changes |
