...
| **Device/web library** | idm-heatpump-api[web]==2.3.0 |
| **License** | MIT |
| **Languages** | DE, EN |
...
- **API boundary**: `idm-heatpump-api[web]==2.3.0` provides batching, decoding and write safety. The API owns its own exception hierarchy; the integration uses the tmodbus-backed socket without a pymodbus dependency
