...
- fix: use published idm heatpump api release (7c46208)
...
- fix: config flow model_hint forwarding, reconfigure web-only fallback and web optimisation (aaf7887)
- fix: web variant switching, Nav2 fallback hardening and release docs (1460e7c)
- fix: resolve edge cases and optimize integration code (#66) (2b94231)
- fix: resolve edge cases and optimize integration code (4a5a524)
- fix: clearer logging and error messages for web-only fallback (fb23ba2)
- fix: fire-and-forget task, int-cast hardening, web-only fallback mode (462742d)
- fix: satisfy ci for nav2 nav10 follow-up (c85e7b7)
- fix: robust Nav2/Nav10 model detection and register filtering (#60) (79bb1e6)
...
- Release v0.8.0-beta.14 - Update changelog and version files (11546e7)
- fix: update API dependency range for release CI (#77) (df6a5b9)
- Release v0.8.0-beta.1 - Update changelog and version files (1b79366)
- Release v0.8.0-beta.2 - Update changelog and version files (14ab30b)
- fix: resolve edge cases and optimize integration code (#66) (2b94231)
- fix: resolve edge cases and optimize integration code (4a5a524)
- Release v0.8.0-beta.10 - Update changelog and version files (efe621c)
- Release v0.8.0-beta.7 - Update changelog and version files (ff00a37)
- Release v0.8.0-beta.6 - Update changelog and version files (dc92887)
- Release v0.8.0-beta.5 - Update changelog and version files (b2d443d)
...
- feat: model-aware web client selection and retroactive detection persistence (#61) (d3e080d)
...
[Full changelog: v0.7.4...v0.8.0-beta.16](https://github.com/Xerolux/idm-heatpump-hass/compare/v0.7.4...v0.8.0-beta.16)

**Developed by:** [Xerolux](https://github.com/Xerolux)
**Integration for:** IDM Navigator 2.0 / 10 by IDM EnergieSysteme GmbH
**License:** MIT

_Generated automatically by GitHub Actions on 2026-07-07 07:06:48 UTC_
...
[Full changelog: v0.8.0-beta.12...v0.8.0-beta.13](https://github.com/Xerolux/idm-heatpump-hass/compare/v0.8.0-beta.12...v0.8.0-beta.13)
...
- Fix beta release compatibility checks (13f1d3d)
- fix: clearer logging and error messages for web-only fallback (fb23ba2)
- fix: fire-and-forget task, int-cast hardening, web-only fallback mode (462742d)
- fix: satisfy ci for nav2 nav10 follow-up (c85e7b7)
- fix: robust Nav2/Nav10 model detection and register filtering (#60) (79bb1e6)
...
[Full changelog: v0.7.3...v0.8.0-beta.10](https://github.com/Xerolux/idm-heatpump-hass/compare/v0.7.3...v0.8.0-beta.10)

**Developed by:** [Xerolux](https://github.com/Xerolux)
**Integration for:** IDM Navigator 2.0 / 10 by IDM EnergieSysteme GmbH
**License:** MIT

_Generated automatically by GitHub Actions on 2026-07-04 19:48:50 UTC_

---

## [0.8.0-beta.7] - 2026-07-04

## v0.8.0-beta.7 - IDM Heatpump

**BETA RELEASE - Testing phase, may contain bugs**

### What changed

- fix: avoid accessing private IdmModbusClient attrs in connection test (049cfb6)
- fix: clearer logging and error messages for web-only fallback (fb23ba2)
- fix: fire-and-forget task, int-cast hardening, web-only fallback mode (462742d)
- fix: satisfy ci for nav2 nav10 follow-up (c85e7b7)
- fix: robust Nav2/Nav10 model detection and register filtering (#60) (79bb1e6)
...
[Full changelog: v0.7.3...v0.8.0-beta.7](https://github.com/Xerolux/idm-heatpump-hass/compare/v0.7.3...v0.8.0-beta.7)

**Developed by:** [Xerolux](https://github.com/Xerolux)
**Integration for:** IDM Navigator 2.0 / 10 by IDM EnergieSysteme GmbH
**License:** MIT

_Generated automatically by GitHub Actions on 2026-07-04 19:16:50 UTC_
...
[Full changelog: v0.7.3...v0.8.0-beta.3](https://github.com/Xerolux/idm-heatpump-hass/compare/v0.7.3...v0.8.0-beta.3)

**Developed by:** [Xerolux](https://github.com/Xerolux)
**Integration for:** IDM Navigator 2.0 / 10 by IDM EnergieSysteme GmbH
**License:** MIT

_Generated automatically by GitHub Actions on 2026-07-03 20:27:27 UTC_
...
[Full changelog: v0.7.3...v0.8.0-beta.2](https://github.com/Xerolux/idm-heatpump-hass/compare/v0.7.3...v0.8.0-beta.2)

**Developed by:** [Xerolux](https://github.com/Xerolux)
**Integration for:** IDM Navigator 2.0 / 10 by IDM EnergieSysteme GmbH
**License:** MIT

_Generated automatically by GitHub Actions on 2026-07-03 20:11:01 UTC_
...
- chore(ci): update actions to Node 24 releases (e76ca60)
- Release v0.7.1 - Update changelog and version files (b43f6eb)
- Release v0.7.1 - Update changelog and version files (fd98c24)
- Release v0.7.1 - Update changelog and version files (1b2f579)
- Release v0.7.1 - Update changelog and version files (56effaf)

### Bug Fixes

- fix(registers): scope library map by detected model (8fd7896)
- fix(compat): resolve F-07 HA 2026.5 baseline (67c09f0)
- fix(ids): resolve F-05/F-06 stable IDs and reloads (51a27bd)
- fix(setup): resolve F-04 client cleanup leak (76386ff)
- fix(diagnostics): resolve F-03 pytest collection (74a8dd1)
- fix(tests): resolve F-02 offline library stub (2da2d54)
- fix: resolve ruff E402 lint failure in registers.py (f83a7bc)
- fix: disable zone-room temp/humidity Vorgabe numbers by default (05af637)
...
[Full changelog: v0.7.1...v0.7.3](https://github.com/Xerolux/idm-heatpump-hass/compare/v0.7.1...v0.7.3)
...
_Generated automatically by GitHub Actions on 2026-07-02 16:53:17 UTC_
...
- feat: wire up enable_cascade and add error logging (0179e4b)

### Improvements

- Release v0.7.0 - Update changelog and version files (518a8f1)
- Release v0.7.0 - Update changelog and version files (0d265e2)

### Bug Fixes

- fix: deduplicate zone registers in number entities (bcb85e9)
...
[Full changelog: v0.7.0...v0.7.1](https://github.com/Xerolux/idm-heatpump-hass/compare/v0.7.0...v0.7.1)
...
_Generated automatically by GitHub Actions on 2026-06-23 04:18:39 UTC_
...
- Release v0.7.1 - Update changelog and version files (de07a7e)
- Release v0.7.1 - Update changelog and version files (76f64f9)
- Release v0.7.0 - Update changelog and version files (518a8f1)
- Release v0.7.0 - Update changelog and version files (0d265e2)

### Bug Fixes

- fix: resolve ruff E402 lint failure in registers.py (c58cbc9)
- fix: disable zone-room temp/humidity Vorgabe numbers by default (d9f0d56)
- fix: deduplicate zone registers in number entities (bcb85e9)
...
- [Report a bug](https://github.com/Xerolux/idm-heatpump-hass/issues/new?template=bug_report.md)
- [Request a feature](https://github.com/Xerolux/idm-heatpump-hass/issues/new?template=feature_request.md)
- [Contribute](https://xerolux.github.io/idm-heatpump-hass/docs/#/contributing)
