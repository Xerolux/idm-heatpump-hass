...
def _default_options() -> dict[str, Any]:
    ...
    return {
        ...
        CONF_FEATURE_PROFILE: DEFAULT_FEATURE_PROFILE,
        CONF_ENERGY_MANAGER: DEFAULT_ENERGY_MANAGER,
        CONF_ENERGY_MANAGER_EXCLUSIVE: DEFAULT_ENERGY_MANAGER_EXCLUSIVE,
        CONF_ENERGY_MANAGER_MIN_SURPLUS: DEFAULT_ENERGY_MANAGER_MIN_SURPLUS,
        CONF_ENERGY_MANAGER_MIN_SOC: DEFAULT_ENERGY_MANAGER_MIN_SOC,
        ...
        **AI_EXTRA_DEFAULTS,
        ...
        CONF_COMFORT_SCHEDULE_CIRCUIT: DEFAULT_COMFORT_SCHEDULE_CIRCUIT,
        ...
        CONF_WEATHER_PREHEAT_THRESHOLD: DEFAULT_WEATHER_PREHEAT_THRESHOLD,
        CONF_EXTERNAL_POWER_FORWARDING_ENTITIES: {},
                ...
                vol.Schema(
                    {
                        vol.Required(
                            CONF_FEATURE_PROFILE,
                            default=options.get(CONF_FEATURE_PROFILE, DEFAULT_FEATURE_PROFILE),
                        ): SelectSelector(
                            SelectSelectorConfig(
                                options=list(FEATURE_PROFILE_OPTIONS),
                                mode=SelectSelectorMode.DROPDOWN,
                                translation_key="feature_profile",
                            )
                        ),
                        vol.Required(
                            CONF_ENERGY_MANAGER,
                        ...
                        vol.Required(
                            CONF_COMFORT_SCHEDULE_EXCLUSIVE,
                            default=options.get(CONF_COMFORT_SCHEDULE_EXCLUSIVE, DEFAULT_COMFORT_SCHEDULE_EXCLUSIVE),
                        ): BooleanSelector(BooleanSelectorConfig()),
                        vol.Required(
                            CONF_COMFORT_SCHEDULE_CIRCUIT,
                        ...
                        vol.Required(
                            CONF_COMFORT_SCHEDULE_END,
                            default=options.get(CONF_COMFORT_SCHEDULE_END, DEFAULT_COMFORT_SCHEDULE_END),
                        ): TextSelector(TextSelectorConfig(type=TextSelectorType.TEXT)),
                        vol.Required(
                            CONF_COMFORT_SCHEDULE_TARGET,
