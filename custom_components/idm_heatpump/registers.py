...
def _hk_sensors(circuit: str) -> list[dict[str, Any]]:
    ...
    return [
        ...
        _sensor(
            1378 + off,
            f"Sollvorlauftemperatur HK {C}",
            f"target_flow_temp_hk_{c}",
            unit=UnitOfTemperature.CELSIUS,
            device_class=UnitOfTemperature.CELSIUS,
            category="hk",
        ),
        ...
        _sensor(
            1401 + off,
            f"Raumsoll Heizen Normal HK {C}",
            f"room_target_heat_normal_{c}",
            unit=UnitOfTemperature.CELSIUS,
            device_class=UnitOfTemperature.CELSIUS,
            category="hk",
        ),
        _sensor(
            1415 + off,
            f"Raumsoll Heizen Eco HK {C}",
            f"room_target_heat_eco_{c}",
            unit=UnitOfTemperature.CELSIUS,
            device_class=UnitOfTemperature.CELSIUS,
            category="hk",
        ),
        ...
        _sensor(
            1457 + off,
            f"Raumsoll Kuehlen Normal HK {C}",
            f"room_target_cool_normal_{c}",
            unit=UnitOfTemperature.CELSIUS,
            device_class=UnitOfTemperature.CELSIUS,
            category="hk",
        ),
        _sensor(
            1471 + off,
            f"Raumsoll Kuehlen Eco HK {C}",
            f"room_target_cool_eco_{c}",
            unit=UnitOfTemperature.CELSIUS,
            device_class=UnitOfTemperature.CELSIUS,
            category="hk",
        ),
        ...
        _sensor(
            1449 + idx,
            f"Vorlauftemperatur Soll Konstant HK {C}",
            f"const_flow_temp_{c}",
            datatype=DataType.UCHAR,
            unit=UnitOfTemperature.CELSIUS,
            device_class=UnitOfTemperature.CELSIUS,
            category="hk",
        ...
        _sensor(
            1650 + off,
            f"Externe Raumtemperatur HK {C}",
            f"room_temp_ext_hk_{c}",
            unit=UnitOfTemperature.CELSIUS,
            device_class=UnitOfTemperature.CELSIUS,
            category="hk",
        ),
...
BINARY_SENSORS = [
    ...
    _binary_sensor(
        1091, "Heizanforderung aktiv", "heating_request_active", icon="mdi:fire"
    ),
    _binary_sensor(
        1092, "Kuehlanforderung aktiv", "cooling_request_active", icon="mdi:snowflake"
    ),
    _binary_sensor(
        1093,
        "Warmwasseranforderung aktiv",
        "dhw_request_active",
...
SOLAR_SELECTS = [
    ...
    _select(1874, "ISC Modus", "isc_mode", ISC_MODE_OPTIONS, icon="mdi:sync"),
]
...
GLT_SWITCHES = [
    _switch(1710, "Anforderung Heizen", "glt_request_heating", icon="mdi:fire"),
    _switch(1711, "Anforderung Kuehlen", "glt_request_cooling", icon="mdi:snowflake"),
    _switch(
        1712, "Anforderung Warmwasserladung", "glt_request_dhw", icon="mdi:water-boiler"
    ),
    _switch(1713, "Einmalige WW-Ladung", "glt_single_dhw", icon="mdi:water-plus"),
]
