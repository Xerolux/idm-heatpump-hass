...
_WEB_VALUE_NAMES: tuple[str, ...] = (
    ...
    "return_temperature",
    *(f"room_temperature_HK_{letter}" for letter in HEATING_CIRCUIT_LETTERS),
...
class IdmApiVersionSensor(IdmCoordinatorEntityBase, SensorEntity):
    ...
    def extra_state_attributes(self) -> dict[str, str]:
        return {
            ...
            "home_assistant_version": self._versions.home_assistant,
            "python_version": self._versions.python,
        }
