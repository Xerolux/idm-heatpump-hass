...
- **Domain**: `idm_heatpump`
- **Version**: `0.8.6-beta.2` (beta; see `docs/release-evidence/0.8.5-beta.8.md` for the latest pre-stable candidate evidence)
- **Min HA**: 2026.5.0
- **Python**: 3.13+
- **Dependencies**: `pymodbus>=3.12.1,<4.0`, `idm-heatpump-api[web]==0.8.6`
