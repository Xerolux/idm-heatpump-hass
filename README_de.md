...
<div align="center">
  ...
  <p>
    ...
    <a href="https://xerolux.github.io/idm-heatpump-hass/docs/"><strong>Dokumentation</strong></a> ·
...
<p align="center">
  <a href="https://github.com/Xerolux/idm-heatpump-hass/releases"><img src="https://img.shields.io/github/release/Xerolux/idm-heatpump-hass.svg?style=for-the-badge" alt="Aktuelles Release"></a>
  ...
  <a href="https://my.home-assistant.io/redirect/config_flow_start/?domain=idm_heatpump"><img src="https://img.shields.io/badge/Home%20Assistant-Installieren-41BDF5.svg?style=for-the-badge&logo=home-assistant&logoColor=white" alt="In Home Assistant hinzufügen"></a>
  <a href="https://hacs.xyz"><img src="https://img.shields.io/badge/HACS-Custom-orange.svg?style=for-the-badge" alt="Benutzerdefinierte HACS-Integration"></a>
  <a href="LICENSE"><img src="https://img.shields.io/github/license/Xerolux/idm-heatpump-hass.svg?style=for-the-badge" alt="MIT-Lizenz"></a>
</p>
...
## Experimenteller KI-Anlagenberater (Beta v0.17.2-b8)
...
Sie bildet die Wärmepumpe mit **denselben Kommunikationsobjekten, Objektnummern
und Datenpunkttypen** auf dem Bus ab wie IDMs eigenes ETS-Beispielprojekt und
schreibt Befehle vom Bus zurück in den Regler.

Sie bringt keinen eigenen KNX-Stack mit, sondern nutzt die vorhandene
**[KNX-Integration von Home Assistant](https://www.home-assistant.io/integrations/knx/)** —
Tunneling, Routing und **KNX Secure** kommen von dort.

| | |
|---|---|
| **Objekte** | 654 IDM-Kommunikationsobjekte, abgebildet auf die Modbus-Register des Navigators |
| **Richtung** | Lesende Objekte werden gesendet; die von IDM als schreibbar geführten nehmen zusätzlich Befehle an |
...
| **📦 Laufzeitversionen** | Diagnose-Sensor und Export zeigen Integration, `idm-heatpump-api`, `modbus-connection` und `tmodbus` |
...
Die vollständige, durchsuchbare Dokumentation findest du auf der **[Projektwebsite][wiki]**:
...
- `modbus-connection==4.12.1` · `tmodbus[async-serial]==0.6.2` (direkter Modbus-Socket)
- `idm-heatpump-api[web]==2.1.2` (Gerätelogik: Registermetadaten, Batching, Decoding, Modellerkennung, Schreibschutz)
...
Home Assistant
    ...
    │       │       │
    │       │       └── modbus-connection 4.12.1 + tmodbus 0.6.2
    │       │               │
...
- **Direkter lokaler Transport**: FC03-/FC04-Lesezugriffe und FC16-Schreibzugriffe laufen über exakt `modbus-connection==4.12.1` und `tmodbus[async-serial]==0.6.2`; `4.12.1` ist die Version der Verbindungsbibliothek, nicht die IDM-Integrationsversion
- **API-Grenze**: `idm-heatpump-api[web]==2.1.2` liefert Registermetadaten, Batching, Encoding/Decoding, Modellerkennung und Schreibschutz. Seit diesem Release besitzt die API ihre eigene Fehlerhierarchie, und pymodbus entfällt: die Integration installiert keinen Modbus-Stack mehr, den sie nicht spricht
...
- 💬 Fragen stellen und anderen in den [GitHub Discussions][discussions] helfen

---

## 🔥 Über IDM Navigator

Der **IDM Navigator 2.0 / 10 / Pro** von [IDM EnergieSysteme GmbH](https://www.idm-energiesysteme.de/) ist ein modulares Wärmepumpen-Steuerungssystem mit Modbus TCP-Schnittstelle für nahtlose Home Assistant Integration.
