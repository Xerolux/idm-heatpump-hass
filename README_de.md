...
- `idm-heatpump-api[web]==2.4.0` (Gerätelogik: Registermetadaten, Batching, Decoding, Modellerkennung, Schreibschutz)
...
- **API-Grenze**: `idm-heatpump-api[web]==2.4.0` liefert Registermetadaten, Batching, Encoding/Decoding, Modellerkennung und Schreibschutz. Seit diesem Release besitzt die API ihre eigene Fehlerhierarchie, und pymodbus entfällt: die Integration installiert keinen Modbus-Stack mehr, den sie nicht spricht
