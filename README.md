...
<div align="center">
  <a href="https://xerolux.github.io/idm-heatpump-hass/">
    <img src="https://raw.githubusercontent.com/Xerolux/idm-heatpump-hass/main/docs/images/idm-home-assistant-hero.jpg" alt="IDM Heatpump integration: local Modbus TCP, local Navigator data and optional KNX" width="900">
  </a>
...
- `modbus-connection==4.10.0` · `tmodbus[async-serial]==0.6.2` (direct Modbus socket runtime)
