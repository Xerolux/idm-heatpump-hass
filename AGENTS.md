...
- **Device Logic**: `idm-heatpump-api[web]==2.4.0` (owns its own exception hierarchy; pymodbus is no longer a dependency)
...
Home Assistant
    ...
    │       │       ├── idm-heatpump-api 2.4.0 (device logic)
...
test_ha/Scripts/python -m pip install homeassistant==2026.8.1 \
    ...
    "idm-heatpump-api[web]==2.4.0" mypy
