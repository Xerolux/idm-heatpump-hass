...
- **Domain**: `idm_heatpump`
- **Current Version**: `0.15.0-beta.2` (defined in `custom_components/idm_heatpump/manifest.json`; previous stable: `0.14.1`)
...
- **Compatibility Dependencies**: `pymodbus>=3.12.1,<4.0`, `idm-heatpump-api[web]==1.0.2` (pymodbus is temporarily required because the pinned API still imports it)
